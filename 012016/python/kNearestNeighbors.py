# -*- coding: utf-8 -*-
"""
Created on Tue Jan 05 07:03:12 2016

@author: agoswami

Code trials from Ch12 of Data Science from Scratch by Joel Grus
...
def knn_classify(k, labeled_points, new_point):
    by_distance = sorted(labeled_points,
                         key = lambda (loc, lang): distance(loc, new_point))
...
def plot_cities():
    ...
    for (longitude, latitude), lang in cities:
        plots[lang][0].append(longitude)
        plots[lang][1].append(latitude)
